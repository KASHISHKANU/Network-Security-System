...
from networksecurity.entity.artifact_entity import DataTransformationConfigArtifact,DataValidationConfigArtifact
...
class DataTransformation:
    def __init__(self,
                 ...
                 data_validation_config_artifact: DataValidationConfigArtifact):
        try:
            self.data_transformation_config: DataTransformationConfig = data_transformation_config
            self.data_validation_config_artifact: DataValidationConfigArtifact = data_validation_config_artifact
    ...
    def initiate_data_transformation(self) -> DataTransformationConfigArtifact:
        ...
        try:
            ...
            train_df = DataTransformation.read_data(self.data_validation_config_artifact.valid_train_file_path)
            test_df = DataTransformation.read_data(self.data_validation_config_artifact.valid_test_file_path)

            # Training dataset and Encoding of target feature
            input_feature_train_df = train_df.drop(columns=[TARGET_COLUMN], axis=1)
            target_feature_train_df = train_df[TARGET_COLUMN]
            target_feature_train_df = target_feature_train_df.replace(-1, 0)

            # Testing dataset and Encoding of target feature`
